...
HelloWorld::HelloWorld()
{
    ...
    groundBody->CreateFixture(&groundBox, 0);
    groundBox.Set(upperRightCorner, upperLeftCorner);
    groundBody->CreateFixture(&groundBox, 0);
	...
	CCLabelTTF *label = CCLabelTTF::create("Tap screen", "Courier New", 32);
	addChild(label, 0);
...
//    CCSprite::crea
	CCSprite *sprite = CCSprite::createWithTexture(sheet->getTexture(),
                                                   CCRectMake(32 * idx,32 * idy,32,32));
